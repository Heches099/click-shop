...
mixin _$CartItemModel {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, product, quantity, selectedColor, selectedSize);

  @override
  String toString() {
    return 'CartItemModel(product: $product, quantity: $quantity, selectedColor: $selectedColor, selectedSize: $selectedSize)';
  }
}
...
extension CartItemModelPatterns on CartItemModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(ProductModel product, int quantity, String? selectedColor,
            String? selectedSize)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _CartItemModel() when $default != null:
        return $default(_that.product, _that.quantity, _that.selectedColor,
            _that.selectedSize);
      case _:
        return orElse();
    }
