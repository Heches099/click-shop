...
mixin _$CategoryModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, parentId, image,
      const DeepCollectionEquality().hash(subcategories));

  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, parentId: $parentId, image: $image, subcategories: $subcategories)';
  }
}
...
extension CategoryModelPatterns on CategoryModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, String? parentId, String? image,
            List<CategoryModel> subcategories)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _CategoryModel() when $default != null:
        return $default(_that.id, _that.name, _that.parentId, _that.image,
            _that.subcategories);
      case _:
        return orElse();
    }
