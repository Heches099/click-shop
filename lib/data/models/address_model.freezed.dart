...
mixin _$AddressModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, phone, street, city,
      state, zipCode, country, isDefault);

  @override
  String toString() {
    return 'AddressModel(id: $id, name: $name, phone: $phone, street: $street, city: $city, state: $state, zipCode: $zipCode, country: $country, isDefault: $isDefault)';
  }
}
